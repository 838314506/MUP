...
public class DictionaryController {
	...
	public String query(DictionaryEntity entity, ModelMap model, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		StringBuffer hql = new StringBuffer("FROM DictionaryEntity WHERE 1=1 ");
		
		Map<String, Object> data = new HashMap<String, Object>();
		model.put("page", dictionaryService.queryPageByCondition(hql.toString(), data, new Page<DictionaryEntity>(request, response)));
	...
	{
		dictionaryService.create(entity, code, val);
	...
	{
		model.put("entity", dictionaryService.get(DictionaryEntity.class, ids));
	...
	{
		dictionaryService.delete(DictionaryEntity.class, ids);
		return "redirect:/dictionary/query.do";
	}
