	...
	<body>
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="ibox float-e-margins">
				<form action="${path }/surface/update.do" method="post" enctype="multipart/form-data"class="form-horizontal" role="form">
				<input type="hidden" id="workId" name="workId" value="${entity.workId }">
				<input type="hidden" id="miningEntity.miningId" name="miningEntity.miningId" value="${entity.miningEntity.miningId}">
                    <fieldset>
                        <legend>修改工作面信息</legend>
