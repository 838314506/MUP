...
import com.zhg.javakc.base.cookie.CookieUtils;
...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append("<li class=\"disabled\"><a href=\"javascript:\">当前 ");
//		sb.append("<input type=\"text\" class=\"input-group\" value=\""+pageNo+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
