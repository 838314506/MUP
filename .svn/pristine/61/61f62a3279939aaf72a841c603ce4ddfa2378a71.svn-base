				...
				<form action="${path }/dictionary/create.do" method="post" class="form-horizontal" role="form">
                    <fieldset>
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-8">
                             <zhg:select codeTp="unit" cls="form-control" name="unit" id="unit"></zhg:select>
                          </div>
                       </div>
                       <div class="form-group">
                          <label class="col-sm-2 control-label" for="ds_username"><zhg:show value="4" codeTp="unit"></zhg:show></label>
                       </div>
                    </fieldset>     
                    <fieldset>
						<legend>编码信息</legend>
