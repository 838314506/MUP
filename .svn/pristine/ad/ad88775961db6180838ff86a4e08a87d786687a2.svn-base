    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                  	...
                  	<zhg:menu role="${sessionScope['roleId']}"></zhg:menu>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=path %>/index_v1.html?v=4.0" data-id="<%=path %>/index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
